...
module.exports = {
    ...
    resolve: {
        alias: {
            ...
            '@dataEn': path.resolve(__dirname, 'src/js/data/dataEn.js'),
            '@dataRu': path.resolve(__dirname, 'src/js/data/dataRu.js'),
            '@CVEN': path.resolve(__dirname, 'src/assets/files/CV-EN.pdf'),
            '@CVRU': path.resolve(__dirname, 'src/assets/files/CV-RU.pdf')
        } 
    },
    devServer: {
        port: 5000,
